...
public enum ParameterDistributionType {
    ...
    RIGHT_SKEWED_GAUSSIAN1("Right skewed gaussian1", new DoubleParameter(0, 0, 10.0, getDefaultName()), new GaussianRedistribution(0.8, 0.1)),
    RIGHT_SKEWED_GAUSSIAN2("Right skewed gaussian2", new DoubleParameter(0, 0, 10.0, getDefaultName()), new GaussianRedistribution(0.9, 0.05)),
    RIGHT_SKEWED_GAUSSIAN3("Right skewed gaussian3", new DoubleParameter(0, 0, 10.0, getDefaultName()), new GaussianRedistribution(0.9, 0.5)),
    LEFT_SKEWED_GAUSSIAN("Left skewed gaussian", new DoubleParameter(0, 0, 10.0, getDefaultName()), new GaussianRedistribution(0.3, 0.3)),
    LEFT_SKEWED_GAUSSIAN1("Left skewed gaussian1", new DoubleParameter(0, 0, 10.0, getDefaultName()), new GaussianRedistribution(0.2, 0.1)),
    LEfT_SKEWED_GAUSSIAN2("Left skewed gaussian2", new DoubleParameter(0, 0, 10.0, getDefaultName()), new GaussianRedistribution(0.1, 0.05)),
    LEfT_SKEWED_GAUSSIAN3("Left skewed gaussian3", new DoubleParameter(0, 0, 10.0, getDefaultName()), new GaussianRedistribution(0.1, 0.7)),
    MIN_SKEWED_GAUSSIAN("Minimum skewed gaussian", new DoubleParameter(0, 0, 10.0, getDefaultName()), new GaussianRedistribution(0.0, 0.1)),
    MAX_SKEWED_GAUSSIAN("Maximum skewed gaussian", new DoubleParameter(0, 0, 10.0, getDefaultName()), new GaussianRedistribution(1.0, 0.1)),
    SPECIAL_UNIFORM2("Special Uniform 0.2", new DoubleParameter(0, 0, 5.0, getDefaultName()), getUniform1()),
    SPECIAL_UNIFORM_LEFT("Special Uniform Left only", new DoubleParameter(0, 0, 5.0, getDefaultName()), getUniformLeft()),
