...
final class PuzzlePanel extends JPanel
{
    ...
    private static final Color TEXT_COLOR = new Color(10, 20, 50);
    ...
    private static void drawPiece(Graphics g, Piece p, int xpos, int ypos) {
        ...
        // draw the topSuit
        nub = p.getNub(Direction.TOP);
        symb[0] = nub.getSuit().getSymbol();
        if ( nub.isOuty() )
