...
final class Solution extends JPanel
{
    ...
    public  boolean fits( Piece p )
    {
        ...
        do {
            ...
            if ( col > 0 ) {
                ...
                Piece leftPiece = (Piece) pieces_.get( numSolved_ - 1 );
            ...
            if ( row > 0 ) {
                ...
                Piece topPiece = (Piece) pieces_.get( numSolved_ - NCOLS );
    ...
    protected void paintComponent( Graphics g )
    {
        ...
        g.drawString( "Number of tries: " + Integer.toString( RedPuzzle.getNumIterations() ),
