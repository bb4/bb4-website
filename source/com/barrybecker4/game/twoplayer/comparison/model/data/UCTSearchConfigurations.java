...
public class UCTSearchConfigurations extends SearchOptionsConfigList {
    ...
    protected void initialize() {
        ...
        add(new SearchOptionsConfig("UCT winrate 500", createUCTOptions(500, WIN_RATE)));
        add(new SearchOptionsConfig("UCT winrate 1000", createUCTOptions(1000, WIN_RATE)));
        add(new SearchOptionsConfig("UCT winrate 2000", createUCTOptions(2000, WIN_RATE)));
        add(new SearchOptionsConfig("UCT nmoves 500", createUCTOptions(500, NUM_VISITS)));
        add(new SearchOptionsConfig("UCT nmoves 1000", createUCTOptions(1000, NUM_VISITS)));
        add(new SearchOptionsConfig("UCT nmoves 2000", createUCTOptions(2000, NUM_VISITS)));
    }
    ...
    private SearchOptions createUCTOptions(int maxSimulations, MaximizationStyle sytle) {
