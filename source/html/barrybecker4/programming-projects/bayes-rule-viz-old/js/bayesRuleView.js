    ...
    module.bayesRuleView = function(parentEl, graph, totalPopulation) {
        ...
        function createExpression() {
            var bayeRuleExp = $("" +
                ...
                '<tr>' +
                '<td rowspan="2" class="cell-nowrap"> p(<span class="diseased">D</span> | <span class="positive">positive</span>)&nbsp; = &nbsp;</td>' +
                ...
                '<td rowspan="2" class="cell-nowrap"> &nbsp; = &nbsp;</td>' +
                '<td rowspan="2" class="cell-grow"> <span class="prob-diseased-result"></span>&nbsp; chance that you are infected. <span class="prob-diseased-worry"></span></td>' +
                '</tr>' +
                '<tr>' +
