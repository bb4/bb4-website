...
public class ProcessingOperations 
{
    ...
    public BufferedImageOp getOperation(String key)
    {
        return mOps.get(key);
    }
    ...
    {
        mOps = new HashMap<String, BufferedImageOp>();
        createConvolutions();        
        createLookups();
    ...
    private void createLookups()
    {
        ...
        mOps.put( "Brighten", 
                new LookupOp( new ShortLookupTable( 0, brightenTable ), null ) );
        ...
        mOps.put( "Invert", 
                new LookupOp( new ShortLookupTable( 0, invertTable ), null ) );
    ...
    {
        WholeImageFilter filter =new CausticsFilter(); 
        mOps.put( "Caustics",  filter);       
